...
def repeat(grain: dict, n: int, interval: int, max_db: float = -18.0) -> np.ndarray:
    """
    Repeats a grain for n times. Applies a window norm to the final assembled grains.
    :param grain: A grain dictionary
